...
public class DataScopeAspect
{
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias, String permission)
    {
        ...
        for (SysRole role : user.getRoles())
        {
            ...
            {
                sqlString.append(StringUtils.format(" OR {}.dept_id = {}  or  {}.dept_id is null  ", deptAlias, user.getDeptId(),deptAlias));
            }
            ...
            else if (DATA_SCOPE_SELF.equals(dataScope))
            {
                ...
                {
                    sqlString.append(StringUtils.format(" OR {}.user_id = {} or  {}.dept_id is null ", userAlias, user.getUserId(),deptAlias));
                }
                else
                {
