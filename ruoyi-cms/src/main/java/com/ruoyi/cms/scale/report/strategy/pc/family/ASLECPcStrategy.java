package com.ruoyi.cms.scale.report.strategy.pc.family;
...
@Component
public class ASLECPcStrategy implements ITemplateStrategy {
    @Override
    public String getTemplate(Long contextId, String deviceType, LbsResultsVo lbsResults)
    {
        String templatePath= "templates/pc/family/aslec.html";
        try {
