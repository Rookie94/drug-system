...
public class SysFileInfoController extends BaseController
{
     ...
     * 查询文件管理列表
     */
    @PreAuthorize("@ss.hasPermi('res:fileInfo:list')")
    @GetMapping("/list")
     ...
     * 导出文件管理列表
     */
    @PreAuthorize("@ss.hasPermi('res:fileInfo:export')")
     ...
     * 获取文件管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('res:fileInfo:query')")
     ...
     * 新增文件管理
     */
    @PreAuthorize("@ss.hasPermi('res:fileInfo:add')")
     ...
     * 修改文件管理
     */
    @PreAuthorize("@ss.hasPermi('res:fileInfo:edit')")
     ...
     * 删除文件管理
     */
    @PreAuthorize("@ss.hasPermi('res:fileInfo:remove')")
